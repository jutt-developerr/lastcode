...
/* Master */
   ...
   // Manage Driver Needed Doc
    ...
    /* manage-owner */
        ...
        PermissionSlug::OWNER_PAYMENT_HISTORY => [
            'name' => 'owner-payment-history',
            'description' => 'owner-payment-history',
            'main_menu'=>'owners',
...
// cms
    ...
    protected $roles = [
        ...
        RoleSlug::ADMIN => [
            ...
            'permissions' => [PermissionSlug::GET_ALL_ROLES, PermissionSlug::GET_ALL_PERMISSIONS,PermissionSlug::ACCESS_DASHBOARD,PermissionSlug::SETTINGS,PermissionSlug::DRIVERS_MENU,PermissionSlug::VIEW_DRIVERS,PermissionSlug::VIEW_TYPES,PermissionSlug::VIEW_ZONE,PermissionSlug::MAP_MENU,PermissionSlug::VIEW_SYSTEM_SETINGS,PermissionSlug::USER_MENU,PermissionSlug::VIEW_USERS,PermissionSlug::SERVICE_LOCATION,PermissionSlug::ADMIN,PermissionSlug::DISPATCH_REQUEST,PermissionSlug::LIST_AIRPORTS,PermissionSlug::ADD_AIRPORTS,PermissionSlug::EDIT_AIRPORTS,
                PermissionSlug::VIEW_TYPES,PermissionSlug::ADD_TYPES,PermissionSlug::EDIT_TYPES,PermissionSlug::DELETE_TYPES,PermissionSlug::TOGGLE_TYPES,PermissionSlug::VEHICLE_FARE,PermissionSlug::ADD_PRICE,PermissionSlug::EDIT_PRICE,PermissionSlug::DELETE_PRICE,PermissionSlug::TOGGLE_PRICE,PermissionSlug::DEFAULT_VEHICLE_TYPE,PermissionSlug::MAP_MENU,PermissionSlug::VIEW_ZONE,PermissionSlug::ADD_ZONE,PermissionSlug::EDIT_ZONE,PermissionSlug::DELETE_ZONE,PermissionSlug::TOGGLE_ZONE
            ],
        ],
